...
void main() {
    ...
    noise = 10.0 *  -0.10 * turbulence( .5 * vec3(0.0,0.0,1.0) + uTime );
    float b = 20.0 * pnoise( 0.05 * displaced + vec3( 2.0 * uTime ), vec3( 100.0 ) );
    float displacement = - noise + b;

    displaced += vec3(0.0,0.0,1.0) * displacement;
